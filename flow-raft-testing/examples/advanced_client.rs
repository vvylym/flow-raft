...
//! - Stream processing
//!
//! **Note:** This example only builds a client and prints the API shape. It does not
//! connect to a server or run workflows. Correctness is limited to "compiles and
//! demonstrates the client builder and method names."
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let _client = FlowRaftClientBuilder::new()
