...
impl WorkflowSnapshot {
    ...
    pub fn from_workflow<State>(workflow: &crate::core::Workflow<State>) -> Self
    where
        for<'a> crate::core::WorkflowState: From<&'a State>,
    {
        Self {
            workflow_id: workflow.id,
            state: crate::core::WorkflowState::from(&workflow.state),
