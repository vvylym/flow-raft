...
use crate::{Workflow, WorkflowCancelled, WorkflowError, WorkflowRunning, WorkflowScheduled};
...
mod tests {
    use super::*;
    use crate::{RetryConfig, TaskDependencies, TaskId, TaskPending, WorkflowDraft};
    use rstest::*;

    #[fixture]
    fn test_workflow() -> Workflow<WorkflowDraft> {
        Workflow::new(crate::WorkflowId::default(), serde_json::json!({}))
    }

    #[fixture]
    fn test_task(#[default(TaskId::default())] id: TaskId) -> crate::Task<TaskPending> {
        crate::Task::new(
            id,
            "test_task",
            "test_handler",
