...
///
/// # Note
/// This function is used in tests and may be used for debugging/analysis.
/// It's kept public for utility purposes but is not part of the core execution path.
pub fn topological_order(
    ...
    // Also visit any tasks that weren't reached from entry tasks
    // (in case of disconnected components or tasks that aren't prerequisites of entry tasks)
